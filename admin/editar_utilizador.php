    ...
    if ($id && $tipo) {
        try {
            if ($tipo === 'cliente') {
                ...
                $email = trim($_POST['email']);
                $telefone = trim($_POST['telefone']);
                $cpf_cnpj = trim($_POST['cpf']);
                $especialidade = trim($_POST['especialidade']);

                $stmt = $pdo->prepare("UPDATE prestador SET nome = ?, sobrenome = ?, email = ?, telefone = ?, cpf = ?, especialidade = ? WHERE id = ?");
    ...
    <div class="container-fluid p-4">
        ...
        <div class="card shadow-sm">
            <div class="card-header">
                <h5 class="mb-0">A editar: <?= htmlspecialchars($tipo === 'cliente' ? $utilizador['nome'] . ' ' . $utilizador['sobrenome'] : $utilizador['nome']) ?></h5>
            </div>
            <div class="card-body">
                <form action="editar_utilizador.php" method="post">
                    ...
                    <?php elseif ($tipo === 'prestador'): ?>
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="sobrenome" class="form-label" placeholder="Digite seu sobrenome:">Sobrenome:</label>
                                <input type="text" class="form-control" id="sobrenome" name="sobrenome" value="<?= htmlspecialchars($utilizador['sobrenome']) ?>">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label" placeholder="Digite seu e-mail:">Email:</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="cpf" class="form-label" placeholder="Digite seu CPF:">CPF/CNPJ:</label>
                                <input type="text" class="form-control" id="cpf" name="cpf" value="<?= htmlspecialchars($utilizador['cpf']) ?>" required>
                            </div>
                        </div>
                        <div class="mb-3">
